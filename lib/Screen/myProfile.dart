...
class _MyProfileState extends State<MyProfile> {
  ...
  void initState() {
    ...
    businessAddressController.text = "${widget.bussinessAddress}";
    ...
    partnerNumberController.text = "${widget.partnerNumber}";
  ...
  businessCategory() async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'https://developmentalphawizz.com/B2B/seller/app/v1/api/business_cat'));
  ...
  getCountries() async {
    ...
    var request = http.MultipartRequest(
        'GET',
        Uri.parse(
            'https://developmentalphawizz.com/B2B/seller/app/v1/api/get_countries'));
    ...
    if (response.statusCode == 200) {
      ...
      String? country_id = jsonResponse.data?[0].id ?? "";
      preferences.setString("country_id", country_id);
      print("Countryyy Id is ${country_id}");
      print("countryyy api responseee ${finalResponse}");
      print("countryy apiii json Response ${jsonResponse}");
      setState(() {
  ...
  getState() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    country_id = preferences.getString("country_id");
    print("Countryyyyy Idddddddd ${country_id}");
    var headers = {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://developmentalphawizz.com/B2B/seller/app/v1/api/get_states'));
    request.fields.addAll({'country_id': country_id.toString()});
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child:
              ...
              //           );
              //
              //           // chooseImage((index==0)?"gallery":"camera");
              //         },
              //         child: CircleAvatar(
              //           child: ClipOval(
              //               child: selectedImage != null
              //                   ? Image.file(
              //                       selectedImage!, // Replace with your image URL
              //                       fit: BoxFit.cover,
              //                       width:
              //                           120, // Adjust the width to your desired size
              //                       height:
              //                           120, // Adjust the height to your desired size
              //                     )
              //                   : Icon(Icons.abc_sharp)),
              //           radius: 50, // Adjust the value as per your desired size
              //         ),
              //       ),
              //     ],
              //   ),
                      ...
                      child: DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? newValue) {
                          setState(() {
                            ...
                            print("selected countryyyy $countryValue");
                          });
                        },
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            prefixIcon: Opacity(
                                opacity: 0.4,
                                child: Image.asset('Images/instagram1.png')),
...
//linkedin page link
                  ...
                  ElevatedButton(
                      onPressed: () {
                        ...
                        // print("${widget.bussinessCategory}");
  ...
  updateProfile() async {
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://developmentalphawizz.com/B2B/seller/app/v1/api/update_user'));
